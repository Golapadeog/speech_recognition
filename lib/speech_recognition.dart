...
class SpeechRecognition {
  ...
  /// [Future] prompt the user to give microphone permission of Google app (mandatory to use SpeechRecognizer)
  /// ***Android supported only ***
  Future openGoogleSettings() => _channel.invokeMethod("speech.openGoogleSettings");
